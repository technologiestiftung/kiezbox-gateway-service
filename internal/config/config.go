...
type GatewayConfig struct {
	...
	Mode          int           `uci:"mode|0|Default device mode as defined in the protobuf" env:"KB_MODE" default:"0"`
	ModeOverride  bool          `uci:"mode_override|false|Enables overwriting the device mode with the cli/env flag" env:"KB_MODE_OVERRIDE" default:"false"`
	CorsLocalhost bool          `uci:"cors_localhost|false|Adds CORS header for local testing only" env:"CORS_LOCALHOST" default:"false"`
}
